...
import Schedule from "./Stats";
import Kanban from "./Kanban";

const TABS = [
  { key: "kanban",   label: "Записи",        component: Kanban },
...
export default function Home() {
  ...
  const ActiveComponent = TABS.find(t => t.key === activeTab)?.component ?? Kanban;

  const handleTabClick = (key) => {
    setActiveTab(key);
    setNavOpen(false); // на мобилке закрываем drawer после выбора
  };
